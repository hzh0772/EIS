<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\wamp64\www\EIS\public/../application/login\view\index\login.html";i:1509368101;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>内网平台</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">请输入您账户密码</p>

    <form action="<?php echo url('/login/check/index'); ?>" method="post">
      <div class="form-group has-feedback">
        <input  name="username" type="username" class="form-control" placeholder="账户">
