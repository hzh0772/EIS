<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"E:\wamp64\www\EIS\public/../application/main\view\profile\index.html";i:1511880947;s:68:"E:\wamp64\www\EIS\public/../application/main\view\layout\layout.html";i:1509368101;s:68:"E:\wamp64\www\EIS\public/../application/main\view\public\header.html";i:1511880947;s:68:"E:\wamp64\www\EIS\public/../application/main\view\public\footer.html";i:1509805269;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="__ROOT__/profile/picture/<?php echo \think\Request::instance()->session('headimg'); ?>" class="user-image" alt="User Image">
                            <span class="hidden-xs"><?php echo \think\Request::instance()->session('name'); ?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="__ROOT__/profile/picture/<?php echo \think\Request::instance()->session('headimg'); ?>" class="img-circle" alt="User Image">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img  src="<?php if(empty(\think\Request::instance()->session('headimg')) || ((\think\Request::instance()->session('headimg') instanceof \think\Collection || \think\Request::instance()->session('headimg') instanceof \think\Paginator ) && \think\Request::instance()->session('headimg')->isEmpty())): ?>__ROOT__/profile/picture/default.jpg<?php else: ?>__ROOT__/profile/picture/<?php echo \think\Request::instance()->session('headimg'); endif; ?>"
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <img class="profile-user-img img-responsive img-circle"
                             src="<?php if(empty(\think\Request::instance()->session('headimg')) || ((\think\Request::instance()->session('headimg') instanceof \think\Collection || \think\Request::instance()->session('headimg') instanceof \think\Paginator ) && \think\Request::instance()->session('headimg')->isEmpty())): ?>__ROOT__/profile/picture/default.jpg<?php else: ?>__ROOT__/profile/picture/<?php echo \think\Request::instance()->session('headimg'); endif; ?>"
                             alt="User profile picture" >

                        <h3 class="profile-username text-center"><?php echo \think\Request::instance()->session('name'); ?></h3>

                        <p class="text-muted text-center"><?php echo \think\Request::instance()->session('title'); ?></p>

                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                                <b>鲜花</b> <a class="pull-right"><?php echo \think\Request::instance()->session('followers'); ?></a>
                            </li>
                            <li class="list-group-item">
                                <b>点赞</b> <a class="pull-right"><?php echo \think\Request::instance()->session('thumbs'); ?></a>
                            </li>
                            <li class="list-group-item">
                                <b>粉丝</b> <a class="pull-right"><?php echo \think\Request::instance()->session('following'); ?></a>
                            </li>
                        </ul>

                        <a href="#" class="btn btn-primary btn-block"><b>加粉</b></a>
                    </div>
                    <!-- /.box-body -->
                </div>
                <!-- /.box -->
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <strong><i class="fa fa-info margin-r-5"></i> 个人简介</strong>

                        <p class="text-muted">
                            <?php echo \think\Request::instance()->session('introduction'); ?>
                        </p>

                        <hr>

                        <strong><i class="fa  fa-hospital-o margin-r-5"></i>科室</strong>

                        <p class="text-muted"><?php echo \think\Request::instance()->session('dept'); ?></p>
                            ...
                            <form class="form-horizontal post">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-4 col-sm-4">
                                        <button type="submit" class="btn btn-danger btn-block">更新个人信息</button>
                                    </div>
                                </div>
                            </form>
                            <form class="form form-horizontal post" action="<?php echo url('main/profile/uploadpicture'); ?>" enctype="multipart/form-data" method="post">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-4 col-sm-4">
                                        <button type="submit" class="btn btn-danger btn-block">上传头像</button>
                                    </div>
                                </div>
                            </form>
